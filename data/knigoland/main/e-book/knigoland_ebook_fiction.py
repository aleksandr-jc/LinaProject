...
def get_data(url):
    ...
    with open('data/knigoland/main/edu_books/knigoland_ebook_fiction.html', 'w') as file:
        file.write(req.text)

    # відкриваємо локально
    with open('data/knigoland/main/edu_books/knigoland_ebook_fiction.html') as file:
        src = file.read()
    ...
    with open('data/knigoland/data/processed/json/knigoland_ebook_fiction.json', 'a', encoding='utf-8') as file:
...
base_url = 'https://knigoland.com.ua/khudozhnya-literatura--?PAGEN_1='  # https://knigoland.com.ua/khudozhnya-literatura--?PAGEN_1=2
