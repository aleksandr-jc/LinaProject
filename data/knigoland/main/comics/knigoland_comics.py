...
def get_data(url):
    ...
    with open('data/knigoland/main/comics/knigoland_comics.html', 'w') as file:
        file.write(req.text)

    # відкриваємо локально
    with open('data/knigoland/main/comics/knigoland_comics.html') as file:
        src = file.read()
    ...
    with open('data/knigoland/data/processed/json/knigoland_comics.json', 'a', encoding='utf-8') as file:
...
# print(f'Page: 1')
# get_data('https://knigoland.com.ua/komiksi')

# робимо цикл щоб пройтись по всім сторінкам
base_url = 'https://knigoland.com.ua/komiksi?PAGEN_1='

# встановлюємо кількість циклів всього 19 сторінок


for url_num in range(11, 20):    # треба ставити range максимальний на одну сторінку більше
    try:
