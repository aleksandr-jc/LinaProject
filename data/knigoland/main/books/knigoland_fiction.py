...
def get_data(url):
    ...
    with open('data/knigoland/main/knigoland_fiction.html', 'w') as file:
        file.write(req.text)

    # відкриваємо локально
    with open('data/knigoland/main/knigoland_fiction.html') as file:
        src = file.read()
    ...
    with open('data/knigoland/data/processed/knigoland_fiction.json', 'a', encoding='utf-8') as file:
