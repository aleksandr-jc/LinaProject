...
def get_data(url):
    ...
    with open('data/knigoland/main/knigoland_teenage.html', 'w') as file:
        file.write(req.text)

    # відкриваємо локально
    with open('data/knigoland/main/knigoland_teenage.html') as file:
        src = file.read()
    ...
    with open('data/knigoland/data/processed/knigoland_teenage.json', 'a', encoding='utf-8') as file:
...
get_data('https://knigoland.com.ua/pidlitkova-literatura')

# робимо цикл щоб пройтись по всім сторінкам
base_url = 'https://knigoland.com.ua/pidlitkova-literatura?PAGEN_1='

start_value = 2
# встановлюємо кількість циклів всього 31 сторінок
max_attempts = 30
