...
def get_data(url):
    ...
    with open('data/knigoland/main/edu_books/knigoland_preschool.html', 'w') as file:
        file.write(req.text)

    # відкриваємо локально
    with open('data/knigoland/main/edu_books/knigoland_preschool.html') as file:
        src = file.read()
    ...
    with open('data/knigoland/data/processed/json/knigoland_preschool.json', 'a', encoding='utf-8') as file:
...
# print(f'Page: 1')
# get_data('https://knigoland.com.ua/doshkilne-navchannya')

# робимо цикл щоб пройтись по всім сторінкам
base_url = 'https://knigoland.com.ua/doshkilne-navchannya?PAGEN_1='

# встановлюємо кількість циклів всього 106 сторінок

# 33 - 42 TODO зробити парсинг ціх сторінок

# get_data('https://knigoland.com.ua/doshkilne-navchannya?PAGEN_1=85')

for url_num in range(33, 43):    # треба ставити range максимальний на одну сторінку більше
    try:
