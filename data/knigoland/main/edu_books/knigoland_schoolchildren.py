...
def get_data(url):
    ...
    with open('data/knigoland/main/edu_books/knigoland_schoolchildren.html', 'w') as file:
        file.write(req.text)

    # відкриваємо локально
    with open('data/knigoland/main/edu_books/knigoland_schoolchildren.html') as file:
        src = file.read()
    ...
    with open('data/knigoland/data/processed/json/knigoland_schoolchildren.json', 'a', encoding='utf-8') as file:
...
# print(f'Page: 1')
# get_data('https://knigoland.com.ua/shkolyaram-abituri-ntam')
...
# 154
for url_num in range(155, 201):    # треба ставити range максимальний на одну сторінку більше
    try:
